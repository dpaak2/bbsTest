...
<div style="position: relative;left: 37.5%;"><h1>디테일 페이지</h1></div>
	...
	<a href="${context}/board.do?action=delete&page=main"><button class="hanbit-btn delete">삭제</button><input name="deleteObject" placeholder="지울 seq_no" type="text" /></a>
	<a href="${context}/board.do?action=move&page=update"><input class="hanbit-btn submit" type="button" value="수정하기" /></a>
</div>
</div>
</form>
</body>
